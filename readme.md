# Epidemiological Forecasting Toolkit
...
## ARIMA Parameter Finder

Automatically identifies optimal ARIMA (p,d,q) parameters for the residual time series.

## Predictions

Performs integrated forecasting using:
